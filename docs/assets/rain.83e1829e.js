import{_ as c,u,a as d,o as f,b as h,d as i,w as r,e as a}from"./index.f76e180b.js";import{E as m}from"./el-button.55669a7a.js";class _{constructor(t,e){if(!t)throw new Error("no viewer object!");e=e||{},this.tiltAngle=Cesium.defaultValue(e.tiltAngle,-.6),this.rainSize=Cesium.defaultValue(e.rainSize,.3),this.rainSpeed=Cesium.defaultValue(e.rainSpeed,60),this.viewer=t,this.init()}init(){this.rainStage=new Cesium.PostProcessStage({name:"czm_rain",fragmentShader:this.rain(),uniforms:{tiltAngle:()=>this.tiltAngle,rainSize:()=>this.rainSize,rainSpeed:()=>this.rainSpeed}}),this.viewer.scene.postProcessStages.add(this.rainStage)}destroy(){if(!this.viewer||!this.rainStage)return;this.viewer.scene.postProcessStages.remove(this.rainStage),this.rainStage.isDestroyed()||this.rainStage.destroy(),delete this.tiltAngle,delete this.rainSize,delete this.rainSpeed}show(t){this.rainStage.enabled=t}rain(){return`uniform sampler2D colorTexture;
