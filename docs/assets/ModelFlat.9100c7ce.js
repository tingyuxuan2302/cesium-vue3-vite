var x=Object.defineProperty;var S=(d,o,e)=>o in d?x(d,o,{enumerable:!0,configurable:!0,writable:!0,value:e}):d[o]=e;var u=(d,o,e)=>(S(d,typeof o!="symbol"?o+"":o,e),e);import{_ as C}from"./OperateBox.2bc9a4e9.js";import{u as w,f as M,a as b,o as T,c as D,w as _,d as g,h as y,j as P,e as E,X as v}from"./index.f76e180b.js";import{E as $}from"./el-button.55669a7a.js";import{P as R,E as V}from"./PlanishArea.4b83e1fe.js";import{D as z}from"./drawGraphic.823774fb.js";class A{constructor(o){u(this,"_tileset");u(this,"_matrix");u(this,"_localMatrix");u(this,"_polygonEdits");this._tileset=o;const e=o.boundingSphere.center.clone();this._matrix=Cesium.Transforms.eastNorthUpToFixedFrame(e),this._localMatrix=Cesium.Matrix4.inverse(this._matrix,new Cesium.Matrix4),this._polygonEdits=[]}addRegionEditsData(o,e,t=0){for(let i=0;i<this._polygonEdits.length;i++)if(this._polygonEdits[i].uuid===o)return;e.length!==0&&(this._polygonEdits.push({uuid:o,show:!0,polygon:this.cartesiansToLocal(e),height:t}),this.renderShader())}addRegionEditsDataArr(o){o.forEach(e=>{const t=e.uuid,i=e.height,l=e.show;let s=[];e.area.forEach(n=>{s.push(new Cesium.Cartesian3(n.x,n.y,n.z))});for(let n=0;n<this._polygonEdits.length;n++)if(this._polygonEdits[n].uuid===t)return;s.length!==0&&(this._polygonEdits.push({uuid:t,show:l,polygon:this.cartesiansToLocal(s),height:i}),console.log(this._polygonEdits))}),this.renderShader()}cartesiansToLocal(o){let e=[];for(let t=0;t<o.length;t++){let i=o[t],l=Cesium.Matrix4.multiplyByPoint(this._localMatrix,i.clone(),new Cesium.Cartesian3);e.push([l.x,l.y])}return e}renderShader(){const o=this.getPointInPolygon(this._polygonEdits);let e="";this._polygonEdits.forEach((t,i)=>{if(t.show){const l=i;t.polygon.forEach((s,n)=>{e+=`points_${l}[${n}] = vec2(${s[0]}, ${s[1]});`}),e+=`
