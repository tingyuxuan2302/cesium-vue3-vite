import{_ as u,a as w,u as l,o as d,b as f,d as t,w as n,e as r}from"./index.f73e044e.js";import{E as v}from"./el-button.456a72d6.js";class m{constructor(s,e){if(!s)throw new Error("no viewer object!");e=e||{},this.snowSize=Cesium.defaultValue(e.snowSize,.02),this.snowSpeed=Cesium.defaultValue(e.snowSpeed,60),this.viewer=s,this.init()}init(){this.snowStage=new Cesium.PostProcessStage({name:"czm_snow",fragmentShader:this.snow(),uniforms:{snowSize:()=>this.snowSize,snowSpeed:()=>this.snowSpeed}}),this.viewer.scene.postProcessStages.add(this.snowStage)}destroy(){if(!this.viewer||!this.snowStage)return;this.viewer.scene.postProcessStages.remove(this.snowStage),this.snowStage.isDestroyed()||this.snowStage.destroy(),delete this.snowSize,delete this.snowSpeed}show(s){this.snowStage.enabled=s}snow(){return`uniform sampler2D colorTexture;
