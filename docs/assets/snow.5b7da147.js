import{_ as u,a as l,o as d,b as f,d as t,w as r,e as i}from"./index.76f76e18.js";import{E as v}from"./el-button.46cdb001.js";class m{constructor(o,e){if(!o)throw new Error("no viewer object!");e=e||{},this.snowSize=Cesium.defaultValue(e.snowSize,.02),this.snowSpeed=Cesium.defaultValue(e.snowSpeed,60),this.viewer=o,this.init()}init(){this.snowStage=new Cesium.PostProcessStage({name:"czm_snow",fragmentShader:this.snow(),uniforms:{snowSize:()=>this.snowSize,snowSpeed:()=>this.snowSpeed}}),this.viewer.scene.postProcessStages.add(this.snowStage)}destroy(){if(!this.viewer||!this.snowStage)return;this.viewer.scene.postProcessStages.remove(this.snowStage),this.snowStage.isDestroyed()||this.snowStage.destroy(),delete this.snowSize,delete this.snowSpeed}show(o){this.snowStage.enabled=o}snow(){return`uniform sampler2D colorTexture;
